//
//  AttentionAtDistanceIsBabyReadyViewController.swift
//  questionApp
//
...
class AttentionAtDistanceIsBabyReadyViewController: UIViewController {
    ...
    @IBAction func onNextStepButtonTap(sender: AnyObject) {
        performSegueWithIdentifier("AADIsBabyReadyToTimeToTestSegueID", sender: self)
    }
