//
//  ReceptiveLanguageIsBabyReadyViewController.swift
//  questionApp
//
...
class ReceptiveLanguageIsBabyReadyViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    // analytics
    Tracker.createEvent(.ReceptiveLanguage, .Load, .IsReady)
  ...
  @IBAction func onNextStepButtonTap(sender: AnyObject) {
    performSegueWithIdentifier("ReceptiveLanguageIsBabyReadyToTimeToTestSegueID", sender: self)
  }
