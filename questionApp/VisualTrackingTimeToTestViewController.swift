//
//  VisualTrackingTimeToTestViewController.swift
//  questionApp
//
...
class VisualTrackingTimeToTestViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    // analytics
    Tracker.createEvent(.VisualTracking, .Load, .TimeToTest)
