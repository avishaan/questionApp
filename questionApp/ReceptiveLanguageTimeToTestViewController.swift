//
//  ReceptiveLanguageTimeToTestViewController.swift
//  questionApp
//
...
class ReceptiveLanguageTimeToTestViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    // analytics
    Tracker.createEvent(.ReceptiveLanguage, .Load, .TimeToTest)
