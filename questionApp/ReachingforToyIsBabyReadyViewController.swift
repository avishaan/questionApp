//
//  ReachingforToyIsBabyReadyViewController.swift
//  questionApp
//
...
class ReachingforToyIsBabyReadyViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    // analytics
    Tracker.createEvent(.ReachingForToy, .Load, .IsReady)
  ...
  @IBAction func onNextStepButtonTap(sender: AnyObject) {
    performSegueWithIdentifier("ReachingForToyIsBabyReadyToTimeToTestSegueID", sender: self)
  }
