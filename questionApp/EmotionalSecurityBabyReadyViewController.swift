//
//  EmotionalSecurityBabyReadyViewController.swift
//  questionApp
//
...
class EmotionalSecurityBabyReadyViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    // analytics
    Tracker.createEvent(.EmotionalSecurity, .Load, .IsReady)
  ...
  @IBAction func onNextStepButtonTap(sender: AnyObject) {
    performSegueWithIdentifier("EmotionalSecurityBabyReadyToTimeToTestSegueID", sender: self)
  }
