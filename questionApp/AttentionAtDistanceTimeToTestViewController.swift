//
//  AttentionAtDistanceTimeToTestViewController.swift
//  questionApp
//
...
class AttentionAtDistanceTimeToTestViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
      // analytics
      Tracker.createEvent(.AttentionAtDistance, .Load, .TimeToTest)
