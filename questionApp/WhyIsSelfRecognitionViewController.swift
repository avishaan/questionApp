...
class WhyIsSelfRecognitionController: UIViewController {
    ...
    func applyTextAttributesToLabel() {
        ...
        let string = "This test assesses baby’s ability to recognize baby's own reflection. This is one step in baby’s development of visual recognition that begins with being able to identify a parent’s face."
