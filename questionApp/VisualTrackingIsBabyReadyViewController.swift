//
//  VisualTrackingIsBabyReadyViewController.swift
//  questionApp
//
...
class VisualTrackingIsBabyReadyViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    // analytics
    Tracker.createEvent(.VisualTracking, .Load, .IsReady)
  ...
  @IBAction func onNextStepButtonTap(sender: AnyObject) {
    performSegueWithIdentifier("VisualTrackingIsBabyReadyToTimeToTestSegueID", sender: self)
  }
