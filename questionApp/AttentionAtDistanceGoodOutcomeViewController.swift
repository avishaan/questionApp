//
//  AttentionAtDistanceGoodOutcomeViewController.swift
//  questionApp
//
...
class AttentionAtDistanceGoodOutcomeViewController: UIViewController {
    ...
    @IBAction func onFacebookButtonTap(sender: AnyObject) {
        ...
        BNFacebook.postToFacebook(self, testName: Test.TestNamesPresentable.attentionAtDistance)
    }
}
