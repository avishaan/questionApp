//
//  ReachingforToyTimeToTestViewController.swift
//  questionApp
//
...
class ReachingforToyTimeToTestViewController: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    // analytics
    Tracker.createEvent(.ReachingForToy, .Load, .TimeToTest)
